      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="md:hidden flex items-center">
            <Link href="/dashboard/landlord" className="font-semibold text-xl">
              HomeRental
            </Link>
          </div>
            ...
            <div className="w-full max-w-lg lg:max-w-xs">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search your properties, bookings..."
                  type="search"
        ...
        <div className="md:hidden">
          <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <a
              ...
              className="block rounded-md px-3 py-2 text-base font-medium text-green-500 hover:bg-gray-700 hover:text-white"
            >
              Add Property
            </a>
            <a
