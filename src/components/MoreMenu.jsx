...
/**
 * More menu component for displaying additional navigation items
 ...
 */
export default function MoreMenu({ items, onItemClick }) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
      <div className="p-4 bg-gray-50 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-500">Additional features and settings</p>
      </div>
